...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Bot Owner - @babyiambadboy", url="https://t.me/babyiambadboy")],
                [InlineKeyboardButton("Support Group", url="https://t.me/bot88updates"),
                 InlineKeyboardButton("Video Channel", url="https://t.me/hhtjhjmfmfm")],
...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/bot88updates).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
        ...
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @babyiambadboy", url="https://t.me/babyiambbadboy"), InlineKeyboardButton("Support Group", url="https://t.me/bot88updates")], [InlineKeyboardButton("Video Channel", url="https://t.me/hhtjhjmfmfm")]]),
            disable_web_page_preview=True
        )
